...
const buttonVariants = {
    ...
    "secondary": "hover:bg-secondary border border-button-border px-4  h-10 flex justify-center items-center text-[14px] font-medium rounded-lg text-button-foreground bg-background duration-100",
    "link": "hover:underline text-[14px]",
    "ghost": "hover:bg-secondary border border-transparent hover:border-muted px-4 h-10 flex justify-center items-center text-[14px] font-medium rounded-lg text-button-foreground duration-100",
