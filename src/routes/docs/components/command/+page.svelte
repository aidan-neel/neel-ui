...
import NextDoc from '$lib/components/next-doc.svelte';    import * as Command from '$lib/components/neel-ui/command';
...
<div class="doc-card-parent">
    <DocCard 
    component="command"
    desc="Command component for searching and executing commands within a page"
    header="Command"
    >
        <CommandExample />
    </DocCard>
