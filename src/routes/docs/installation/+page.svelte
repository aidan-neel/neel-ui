...
<main class="w-[45rem] flex flex-col mt-24  ">
    ...
    <div class="p-4 w-full   bg-secondary-muted shadow-class border rounded-lg mt-4 font-mono text-[14px]">
    ...
    <div class="p-4 w-full flex flex-col   gap-1 bg-secondary-muted shadow-class border rounded-lg mt-4 font-mono text-[14px]">
